(function(define, global) {
    define('module/Nova.switchable/1.0.0/carousel', ['module/Nova.switchable/1.0.0/switchable'], function(Switchable) {
        ...
        var Carousel = Switchable.extend({
            attrs: {
                ...
                autoplay: false,            // 自动轮播
                autoplay_interval: 10000,   // 自动轮播间隔
                swipable: true,             // 是否可滑动
