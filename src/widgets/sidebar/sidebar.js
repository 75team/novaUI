(function() {
    ...
    this.Sidebar = Widget.extend({
        ...
        _animateOpen: function(displayPos) {
            var me = this;
            this.element.animate(this._getXCssObj(displayPos['sidebar'][1]), this.duration, 'ease', function() {
                me.trigger('afteropen');
            });
            this.content.animate(this._getXCssObj(displayPos['cont'][1]), this.duration, 'ease');
        },

        _animateClose: function(displayPos) {
            var me = this;
            this.element.animate(this._getXCssObj(displayPos['sidebar'][0]), this.duration, 'ease', function() {
                me.trigger('afterclose');
            });
            this.content.animate(this._getXCssObj(displayPos['cont'][0]), this.duration, 'ease');
        },
